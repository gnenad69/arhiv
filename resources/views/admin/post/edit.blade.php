        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card" style="background-color:#262626; color:white;">
                    <div class="card-header">Измени пост</div>
                    ...
                    <div class="card-body" style="background-color:#404040;">
                        ...
                        <div class="form-group @if($errors->has('title')) has-error @endif">
                            {!! Form::label('Наслов') !!}
                            {!! Form::text('title', $post->title, ['class' => 'form-control', 'placeholder' => 'Наслов']) !!}
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group @if($errors->has('sub_title')) has-error @endif">
                            ...
                            {!! Form::text('sub_title', $post->sub_title, ['class' => 'form-control', 'placeholder' => 'Поднеслов']) !!}
                        ...
                        <div class="form-group @if($errors->has('details')) has-error @endif">
                            {!! Form::label('Текст') !!}
                            {!! Form::textarea('details', $post->details, ['class' => 'form-control', 'placeholder' => 'Текст']) !!}
